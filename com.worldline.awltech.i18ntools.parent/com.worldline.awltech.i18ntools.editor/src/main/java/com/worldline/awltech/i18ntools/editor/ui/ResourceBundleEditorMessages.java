...
public enum ResourceBundleEditorMessages {
	ERROR_INPUTNOTFILE("ERROR_INPUTNOTFILE"), ERROR_INPUTNOTCU("ERROR_INPUTNOTCU"), ERROR_FAILTOPARSECODE("ERROR_FAILTOPARSECODE"), LABEL_OPTIONSGROUP("LABEL_OPTIONSGROUP"), LABEL_TABLEGROUP("LABEL_TABLEGROUP"), LABEL_LOCALECOMBO("LABEL_LOCALECOMBO"), LABEL_LOCALEBUTTON("LABEL_LOCALEBUTTON"), LABEL_NEWKEYLABEL("LABEL_NEWKEYBUTTON"), LABEL_NEWKEYBUTTON("LABEL_NEWKEYBUTTON"), LABEL_KEYCOLUMN("LABEL_KEYCOLUMN"), LABEL_DEFAULTCOLUMN("LABEL_DEFAULTCOLUMN"), LABEL_LOCALECOLUMN("LABEL_LOCALECOLUMN")
	;
